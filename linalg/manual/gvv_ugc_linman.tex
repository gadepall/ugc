...
\begin{abstract}
This book provides an introduction to college level Linear Algebra based solved
exercises from the UGC-NET exam.
\end{abstract}


\section{Spectral Decomposition}
\input{chapters/spectral/spectral.tex}
\section{Jordan Canonical Form}
\input{chapters/jordan/jordan.tex}
